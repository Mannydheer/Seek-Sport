  ...
  return (
    <Wrapper>
      ...
      <StyledHomeImg>
        ...
        <NavigationLink exact to="/sports">
          <h2>Find Games</h2>
        </NavigationLink>
        {/*  */}
      </StyledHomeImg>
      ...
      <PurposeWrapper>
        <PurposeText>
          ...
          <p>
            Finding people who want to play the same sport, at the same time, in
            the same area is hard and that's the reason why most of us end up
            not playing sport at all. Seek&Sport helps you connect with people
            around you, with similar profiles, and start playing the sport of
            your choice.{" "}
          </p>
        </PurposeText>
